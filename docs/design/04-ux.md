...
`supersedesResultId`, and the certificate is revoked and reissued rather than
edited. The candidate list shows the effective result and a link to its history.
