...
-- CreateIndex
CREATE UNIQUE INDEX "Student_organizationId_identityKey_key" ON "Student"("organizationId", "identityKey");

-- CreateIndex
CREATE INDEX "Student_organizationId_isActive_idx" ON "Student"("organizationId", "isActive");

-- CreateIndex
CREATE INDEX "Student_organizationId_swimLevel_idx" ON "Student"("organizationId", "swimLevel");

-- CreateIndex
CREATE INDEX "Student_organizationId_lastName_firstName_idx" ON "Student"("organizationId", "lastName", "firstName");
